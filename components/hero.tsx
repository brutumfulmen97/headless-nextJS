            ...
            >
              <div>
                <a
                  ...
                  href={content.callToActionsCollection.items[0].href}
                >
                  {content.callToActionsCollection.items[0].text}{" "}
                  <span className="tracking-normal text-purple-500 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                    -&gt;
                  </span>
                </a>
              ...
              <div>
                <a
                  ...
                  href={content.callToActionsCollection.items[1].href}
                >
                  <svg
                  ...
                  <span>{content.callToActionsCollection.items[1].text}</span>
                </a>
              </div>
            </div>
          </div>
